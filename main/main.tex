...
\todo[inline]{Do we label all equations?}
...
%Two dimensional application to signals of limited bandwidt
...
\todo{Substitute all RT to RS or vice versa?}
...
constitutes an orthogonal base on $[q\Gamma, \Gamma]$.\todo{cite!}
...
\todo[inline]{The subsections are not supposed to be like this in the end, only pointers to what we want to discuss}
hej
